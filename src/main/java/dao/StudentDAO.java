...
public class StudentDAO {
	...
	public void addStudent(Student student) {
		String sql = "INSERT INTO students (student_id, name, gender, address, graduation_status, course) VALUES (?, ?, ?, ?, ?,?)";
        try  {
	...
	public void updateStudent(Student student) {
		String sql = "update students set name = ?, gender = ?, address = ?, graduation_status = ? where student_id = ?;";
