...
public class TeacherDAO {
	...
	public void addTeacher(Teacher teacher) {
		String sql = "INSERT INTO Teachers (name, gender, phone_number, position, email) VALUES (?, ?, ?, ?, ?)";
		try {
	...
	public void updateTeacher(Teacher teacher) {
		String sql = "update teachers set name = ?, gender = ?, phone_number = ?, position = ?,email= ? where id = ?;";
		boolean rowUpdate;
		try {
            PreparedStatement preparedStatement = con.prepareStatement(sql);
